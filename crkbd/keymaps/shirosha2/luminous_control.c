...
static layer_state_t zst_LMCTL_layer_state;    /* [-,-] Layer state for the luminous control    */

/********************************************************************************************************************************/
/*  Functions                                                                                                                   */
/********************************************************************************************************************************/
static void m_lmctl_data_latch(void);
...
/****************************************************************/
static void m_lmctl_data_latch(void) {
    zst_LMCTL_layer_state = layer_state;                     /* Update the layer state   */
}
